...
typedef enum {AESL_AUTO_0} picnic_params_t;
...
char sk[49])
{
	...
	if (wrapc_switch_file_token.good())
	{
		...
		if (atoi(AESL_num.c_str()) == AESL_transaction_pc)
		{
			...
			sc_bv<8> *pk_pc_buffer = new sc_bv<8>[33];
			int i = 0;
			...
			if (i > 0)
			{
				// RTL Name: pk
				{
					...
					// {
						// celement: pk(7, 0)
						// {
							sc_lv<8>* pk_lv0_0_32_1 = new sc_lv<8>[33];
						// }
					// }
					...
					// bitslice(7, 0)
					{
						...
						// celement: pk(7, 0)
						{
							...
							for (int i_0 = 0; i_0 <= 32; i_0 += 1)
							{
								...
								{
									pk_lv0_0_32_1[hls_map_index].range(7, 0) = sc_bv<8>(pk_pc_buffer[hls_map_index].range(7, 0));
									hls_map_index++;
								}
							}
						}
					...
					// bitslice(7, 0)
					{
						...
						// celement: pk(7, 0)
						{
							...
							for (int i_0 = 0; i_0 <= 32; i_0 += 1)
							{
								...
								// output_type_conversion : (pk_lv0_0_32_1[hls_map_index]).to_uint64()
								if (&(pk[0]) != NULL) // check the null address if the c port is array or others
								{
									pk[i_0] = (pk_lv0_0_32_1[hls_map_index]).to_uint64();
									hls_map_index++;
								}
							}
						}
		...
		if (atoi(AESL_num.c_str()) == AESL_transaction_pc)
		{
			...
			sc_bv<8> *sk_pc_buffer = new sc_bv<8>[49];
			int i = 0;
			...
			if (i > 0)
			{
				// RTL Name: sk
				{
					...
					// {
						// celement: sk(7, 0)
						// {
							sc_lv<8>* sk_lv0_0_48_1 = new sc_lv<8>[49];
						// }
					// }
					...
					// bitslice(7, 0)
					{
						...
						// celement: sk(7, 0)
						{
							...
							for (int i_0 = 0; i_0 <= 48; i_0 += 1)
							{
								...
								{
									sk_lv0_0_48_1[hls_map_index].range(7, 0) = sc_bv<8>(sk_pc_buffer[hls_map_index].range(7, 0));
									hls_map_index++;
								}
							}
						}
					...
					// bitslice(7, 0)
					{
						...
						// celement: sk(7, 0)
						{
							...
							for (int i_0 = 0; i_0 <= 48; i_0 += 1)
							{
								...
								// output_type_conversion : (sk_lv0_0_48_1[hls_map_index]).to_uint64()
								if (&(sk[0]) != NULL) // check the null address if the c port is array or others
								{
									sk[i_0] = (sk_lv0_0_48_1[hls_map_index]).to_uint64();
									hls_map_index++;
								}
							}
						}
	...
	else
	{
		...
		// [[transaction]]
		sprintf(tvin_params, "[[transaction]] %d\n", AESL_transaction);
		aesl_fh.write(AUTOTB_TVIN_params, tvin_params);

		sc_bv<4>* params_tvin_wrapc_buffer = new sc_bv<4>[1];
			...
			// bitslice(3, 0)
			{
				...
				// celement: params(3, 0)
				{
					...
					for (int i_0 = 0; i_0 <= 0; i_0 += 1)
					{
						...
						// ori_name              : params
						// sub_1st_elem          : 0
						// ori_name_1st_elem     : params
						// regulate_c_name       : params
						// input_type_conversion : params
						if (&(params) != NULL) // check the null address if the c port is array or others
						{
							sc_lv<4> params_tmp_mem;
							params_tmp_mem = params;
							params_tvin_wrapc_buffer[hls_map_index].range(3, 0) = params_tmp_mem.range(3, 0);
                                 	       hls_map_index++;
						}
					}
				}
		...
		for (int i = 0; i < 1; i++)
		{
			sprintf(tvin_params, "%s\n", (params_tvin_wrapc_buffer[i]).to_string(SC_HEX).c_str());
			aesl_fh.write(AUTOTB_TVIN_params, tvin_params);
		}

		tcl_file.set_num(1, &tcl_file.params_depth);
		sprintf(tvin_params, "[[/transaction]] \n");
		aesl_fh.write(AUTOTB_TVIN_params, tvin_params);

		// release memory allocation
		delete [] params_tvin_wrapc_buffer;
...
// [call_c_dut] ---------->
		...
		sc_bv<8>* pk_tvout_wrapc_buffer = new sc_bv<8>[33];
		...
		sc_bv<8>* sk_tvout_wrapc_buffer = new sc_bv<8>[49];
		...
		delete [] tvout_sk;
		delete [] tvin_sk;
		// release memory allocation: "params"
		delete [] tvin_params;

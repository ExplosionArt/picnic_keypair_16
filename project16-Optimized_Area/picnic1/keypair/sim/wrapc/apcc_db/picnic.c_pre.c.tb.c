...
if (AESL_DEBUG_TRACE)
printf("\n  %%101 = ashr i32 %%storemerge14, 2, !dbg !20 for 0x%I64xth hint within @picnic_keygen  --> \n", ++aesl_llvm_cbe_331_count);
  llvm_cbe_tmp__136 = (unsigned int )((signed int )(((signed int )llvm_cbe_storemerge14) >> ((signed int )2u)));
if (AESL_DEBUG_TRACE)

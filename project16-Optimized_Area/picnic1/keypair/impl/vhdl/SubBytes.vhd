...
architecture behav of SubBytes is 
    ...
    signal zext_ln277_fu_91_p1 : STD_LOGIC_VECTOR (5 downto 0);
    signal zext_ln277_reg_142 : STD_LOGIC_VECTOR (5 downto 0);
    signal icmp_ln275_fu_79_p2 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal icmp_ln277_fu_95_p2 : STD_LOGIC_VECTOR (0 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln277_fu_95_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state3))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            ...
            elsif (((icmp_ln275_fu_79_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state2))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln277_fu_95_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state3))) then
                state_addr_reg_155 <= zext_ln279_1_fu_124_p1(4 - 1 downto 0);
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln275_fu_79_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state2))) then
                    zext_ln277_reg_142(2 downto 0) <= zext_ln277_fu_91_p1(2 downto 0);
            end if;
        end if;
    end process;
    zext_ln277_reg_142(5 downto 3) <= "000";

    ap_NS_fsm_assign_proc : process (ap_start, ap_CS_fsm, ap_CS_fsm_state1, ap_CS_fsm_state2, icmp_ln275_fu_79_p2, ap_CS_fsm_state3, icmp_ln277_fu_95_p2)
    begin
        case ap_CS_fsm is
            ...
            when ap_ST_fsm_state2 => 
                if (((icmp_ln275_fu_79_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state2))) then
                    ap_NS_fsm <= ap_ST_fsm_state1;
                else
    ...
    add_ln279_fu_119_p2 <= std_logic_vector(unsigned(zext_ln277_reg_142) + unsigned(zext_ln279_fu_115_p1));
    ...
    ap_done_assign_proc : process(ap_start, ap_CS_fsm_state1, ap_CS_fsm_state2, icmp_ln275_fu_79_p2)
    begin
        if ((((icmp_ln275_fu_79_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state2)) or ((ap_start = ap_const_logic_0) and (ap_const_logic_1 = ap_CS_fsm_state1)))) then 
    ...
    ap_ready_assign_proc : process(ap_CS_fsm_state2, icmp_ln275_fu_79_p2)
    begin
        if (((icmp_ln275_fu_79_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state2))) then 
    ...
    icmp_ln275_fu_79_p2 <= "1" when (i_0_reg_57 = ap_const_lv3_4) else "0";
    icmp_ln277_fu_95_p2 <= "1" when (j_0_reg_68 = ap_const_lv3_4) else "0";
    j_fu_101_p2 <= std_logic_vector(unsigned(j_0_reg_68) + unsigned(ap_const_lv3_1));
    sbox_address0 <= zext_ln279_2_fu_129_p1(8 - 1 downto 0);
    ...
    state_address0_assign_proc : process(ap_CS_fsm_state3, state_addr_reg_155, ap_CS_fsm_state5, zext_ln279_1_fu_124_p1)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state5)) then 
            state_address0 <= state_addr_reg_155;
        elsif ((ap_const_logic_1 = ap_CS_fsm_state3)) then 
            state_address0 <= zext_ln279_1_fu_124_p1(4 - 1 downto 0);
        else 
            state_address0 <= "XXXX";
        end if; 
    end process;

...
set Spec2ImplPortList { 
	...
	state { ap_memory {  { state_address0 mem_address 1 3 }  { state_ce0 mem_ce 1 1 }  { state_q0 mem_dout 0 32 }  { state_address1 MemPortADDR2 1 3 }  { state_ce1 MemPortCE2 1 1 }  { state_q1 MemPortDOUT2 0 32 } } }

...
# 353 "C:/project16-master/NIST-KATs/aes.c"
...
# 478 "C:/project16-master/NIST-KATs/aes.c"
void AES_ECB_encrypt(struct AES_ctx *ctx, state_t* buf)
{
...
# 501 "C:/project16-master/NIST-KATs/aes.c"
...
# 548 "C:/project16-master/NIST-KATs/aes.c"
void AES_CTR_xcrypt_buffer(struct AES_ctx* ctx, uint8_t* buf, uint32_t length)
{
  uint8_t buffer[16];

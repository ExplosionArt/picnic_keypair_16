# 1 "C:/project16-master/hash.c"
# 1 "C:/project16-master/hash.c" 1
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 147 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "C:/project16-master/hash.c" 2
# 12 "C:/project16-master/hash.c"
...
# 21 "C:/project16-master/hash.h" 2
...
# 13 "C:/project16-master/hash.c" 2
...
# 14 "C:/project16-master/hash.c" 2
...
# 15 "C:/project16-master/hash.c" 2
# 1 "C:/project16-master/sha3/brg_endian.h" 1
# 16 "C:/project16-master/hash.c" 2
...
void HashFinal(HashInstance* ctx)
{
    ...
    if (ret != SUCCESS) {
        fprintf((&__iob_func()[2]), "%s: Keccak_HashFinal failed (returned %d)\n", __func__, ret);
    }
}

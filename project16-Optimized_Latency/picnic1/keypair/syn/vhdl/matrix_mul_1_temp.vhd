...
entity matrix_mul_1_temp_ram is 
    generic(
...
architecture rtl of matrix_mul_1_temp_ram is 
...
architecture arch of matrix_mul_1_temp is
    component matrix_mul_1_temp_ram is
        port (
            clk : IN STD_LOGIC;
...
begin
    matrix_mul_1_temp_ram_U :  component matrix_mul_1_temp_ram
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,

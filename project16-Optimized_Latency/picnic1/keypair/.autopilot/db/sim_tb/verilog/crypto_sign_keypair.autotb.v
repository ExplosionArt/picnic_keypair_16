...
`define AUTOTB_TVIN_pk  "./c.crypto_sign_keypair.autotvin_pk.dat"
`define AUTOTB_TVIN_sk  "./c.crypto_sign_keypair.autotvin_sk.dat"
`define AUTOTB_TVIN_params  "./c.crypto_sign_keypair.autotvin_params.dat"
`define AUTOTB_TVIN_DRBG_ctx_V  "./c.crypto_sign_keypair.autotvin_DRBG_ctx_V.dat"
`define AUTOTB_TVIN_DRBG_ctx_Key  "./c.crypto_sign_keypair.autotvin_DRBG_ctx_Key.dat"
`define AUTOTB_TVIN_DRBG_ctx_reseed_counter  "./c.crypto_sign_keypair.autotvin_DRBG_ctx_reseed_counter.dat"
`define AUTOTB_TVIN_pk_out_wrapc  "./rtl.crypto_sign_keypair.autotvin_pk.dat"
`define AUTOTB_TVIN_sk_out_wrapc  "./rtl.crypto_sign_keypair.autotvin_sk.dat"
`define AUTOTB_TVIN_params_out_wrapc  "./rtl.crypto_sign_keypair.autotvin_params.dat"
`define AUTOTB_TVIN_DRBG_ctx_V_out_wrapc  "./rtl.crypto_sign_keypair.autotvin_DRBG_ctx_V.dat"
`define AUTOTB_TVIN_DRBG_ctx_Key_out_wrapc  "./rtl.crypto_sign_keypair.autotvin_DRBG_ctx_Key.dat"
`define AUTOTB_TVIN_DRBG_ctx_reseed_counter_out_wrapc  "./rtl.crypto_sign_keypair.autotvin_DRBG_ctx_reseed_counter.dat"
`define AUTOTB_TVOUT_pk  "./c.crypto_sign_keypair.autotvout_pk.dat"
`define AUTOTB_TVOUT_sk  "./c.crypto_sign_keypair.autotvout_sk.dat"
`define AUTOTB_TVOUT_DRBG_ctx_V  "./c.crypto_sign_keypair.autotvout_DRBG_ctx_V.dat"
`define AUTOTB_TVOUT_DRBG_ctx_Key  "./c.crypto_sign_keypair.autotvout_DRBG_ctx_Key.dat"
`define AUTOTB_TVOUT_DRBG_ctx_reseed_counter  "./c.crypto_sign_keypair.autotvout_DRBG_ctx_reseed_counter.dat"
`define AUTOTB_TVOUT_ap_return  "./c.crypto_sign_keypair.autotvout_ap_return.dat"
`define AUTOTB_TVOUT_pk_out_wrapc  "./impl_rtl.crypto_sign_keypair.autotvout_pk.dat"
`define AUTOTB_TVOUT_sk_out_wrapc  "./impl_rtl.crypto_sign_keypair.autotvout_sk.dat"
`define AUTOTB_TVOUT_DRBG_ctx_V_out_wrapc  "./impl_rtl.crypto_sign_keypair.autotvout_DRBG_ctx_V.dat"
`define AUTOTB_TVOUT_DRBG_ctx_Key_out_wrapc  "./impl_rtl.crypto_sign_keypair.autotvout_DRBG_ctx_Key.dat"
`define AUTOTB_TVOUT_DRBG_ctx_reseed_counter_out_wrapc  "./impl_rtl.crypto_sign_keypair.autotvout_DRBG_ctx_reseed_counter.dat"
`define AUTOTB_TVOUT_ap_return_out_wrapc  "./impl_rtl.crypto_sign_keypair.autotvout_ap_return.dat"
module `AUTOTB_TOP;

parameter AUTOTB_TRANSACTION_NUM = 1;
parameter PROGRESS_TIMEOUT = 10000000;
parameter LATENCY_ESTIMATION = 89652;
...
wire  DRBG_ctx_Key_we1;
wire [7 : 0] DRBG_ctx_Key_d1;
...
`AUTOTB_DUT `AUTOTB_DUT_INST(
    ...
    .DRBG_ctx_Key_we1(DRBG_ctx_Key_we1),
    .DRBG_ctx_Key_d1(DRBG_ctx_Key_d1),
...
assign arrayDRBG_ctx_Key_we1 = DRBG_ctx_Key_we1;
assign arrayDRBG_ctx_Key_din1 = DRBG_ctx_Key_d1;
...
initial begin : generate_AESL_ready_cnt_proc
    ...
    initial begin : finish_simulation
        ...
        @ (posedge AESL_clock);
        @ (posedge AESL_clock);
    fp1 = $fopen("./rtl.crypto_sign_keypair.autotvout_pk.dat", "r");
    fp2 = $fopen("./impl_rtl.crypto_sign_keypair.autotvout_pk.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.crypto_sign_keypair.autotvout_pk.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.crypto_sign_keypair.autotvout_pk.dat\"!");
    else begin
        $display("Comparing rtl.crypto_sign_keypair.autotvout_pk.dat with impl_rtl.crypto_sign_keypair.autotvout_pk.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
    fp1 = $fopen("./rtl.crypto_sign_keypair.autotvout_sk.dat", "r");
    fp2 = $fopen("./impl_rtl.crypto_sign_keypair.autotvout_sk.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.crypto_sign_keypair.autotvout_sk.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.crypto_sign_keypair.autotvout_sk.dat\"!");
    else begin
        $display("Comparing rtl.crypto_sign_keypair.autotvout_sk.dat with impl_rtl.crypto_sign_keypair.autotvout_sk.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
    fp1 = $fopen("./rtl.crypto_sign_keypair.autotvout_DRBG_ctx_V.dat", "r");
    fp2 = $fopen("./impl_rtl.crypto_sign_keypair.autotvout_DRBG_ctx_V.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.crypto_sign_keypair.autotvout_DRBG_ctx_V.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.crypto_sign_keypair.autotvout_DRBG_ctx_V.dat\"!");
    else begin
        $display("Comparing rtl.crypto_sign_keypair.autotvout_DRBG_ctx_V.dat with impl_rtl.crypto_sign_keypair.autotvout_DRBG_ctx_V.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
    fp1 = $fopen("./rtl.crypto_sign_keypair.autotvout_DRBG_ctx_Key.dat", "r");
    fp2 = $fopen("./impl_rtl.crypto_sign_keypair.autotvout_DRBG_ctx_Key.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.crypto_sign_keypair.autotvout_DRBG_ctx_Key.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.crypto_sign_keypair.autotvout_DRBG_ctx_Key.dat\"!");
    else begin
        $display("Comparing rtl.crypto_sign_keypair.autotvout_DRBG_ctx_Key.dat with impl_rtl.crypto_sign_keypair.autotvout_DRBG_ctx_Key.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
    fp1 = $fopen("./rtl.crypto_sign_keypair.autotvout_DRBG_ctx_reseed_counter.dat", "r");
    fp2 = $fopen("./impl_rtl.crypto_sign_keypair.autotvout_DRBG_ctx_reseed_counter.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.crypto_sign_keypair.autotvout_DRBG_ctx_reseed_counter.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.crypto_sign_keypair.autotvout_DRBG_ctx_reseed_counter.dat\"!");
    else begin
        $display("Comparing rtl.crypto_sign_keypair.autotvout_DRBG_ctx_reseed_counter.dat with impl_rtl.crypto_sign_keypair.autotvout_DRBG_ctx_reseed_counter.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
    fp1 = $fopen("./rtl.crypto_sign_keypair.autotvout_ap_return.dat", "r");
    fp2 = $fopen("./impl_rtl.crypto_sign_keypair.autotvout_ap_return.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.crypto_sign_keypair.autotvout_ap_return.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.crypto_sign_keypair.autotvout_ap_return.dat\"!");
    else begin
        $display("Comparing rtl.crypto_sign_keypair.autotvout_ap_return.dat with impl_rtl.crypto_sign_keypair.autotvout_ap_return.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);

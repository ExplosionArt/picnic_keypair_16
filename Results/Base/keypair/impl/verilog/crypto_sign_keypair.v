...
wire   [0:0] icmp_ln539_fu_309_p2;
wire   [5:0] zext_ln542_fu_330_p1;
reg   [5:0] zext_ln542_reg_444;
wire    ap_CS_fsm_state5;
wire   [4:0] loop_5_fu_340_p2;
reg   [4:0] loop_5_reg_452;
wire   [0:0] icmp_ln542_fu_334_p2;
...
wire   [3:0] grp_picnic_keygen_fu_250_DRBG_ctx_V_address1;
wire    grp_picnic_keygen_fu_250_DRBG_ctx_V_ce1;
...
wire   [4:0] grp_picnic_keygen_fu_250_DRBG_ctx_Key_address1;
wire    grp_picnic_keygen_fu_250_DRBG_ctx_Key_ce1;
...
wire   [63:0] zext_ln540_fu_321_p1;
wire   [63:0] zext_ln540_1_fu_326_p1;
wire   [63:0] zext_ln543_fu_346_p1;
wire   [63:0] zext_ln543_1_fu_360_p1;
wire   [63:0] zext_ln614_fu_365_p1;
wire   [63:0] zext_ln615_fu_388_p1;
wire   [63:0] zext_ln616_fu_397_p1;
wire   [63:0] zext_ln617_fu_407_p1;
wire   [7:0] zext_ln536_fu_304_p1;
wire   [7:0] zext_ln609_fu_351_p1;
wire   [5:0] add_ln543_1_fu_355_p2;
...
always @ (posedge ap_clk) begin
    ...
    end else if (((grp_picnic_keygen_fu_250_ap_done == 1'b1) & (1'b1 == ap_CS_fsm_state2) & (icmp_ln66_fu_298_p2 == 1'd0))) begin
...
always @ (posedge ap_clk) begin
    ...
    end else if (((1'b1 == ap_CS_fsm_state5) & (icmp_ln542_fu_334_p2 == 1'd1))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state3) & (icmp_ln539_fu_309_p2 == 1'd1))) begin
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state5)) begin
        ...
        zext_ln542_reg_444[4 : 0] <= zext_ln542_fu_330_p1[4 : 0];
    end
end
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state6)) begin
        pk_address0 = zext_ln543_1_fu_360_p1;
    end else if ((1'b1 == ap_CS_fsm_state4)) begin
        pk_address0 = zext_ln540_1_fu_326_p1;
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state3)) begin
        pubkey_ciphertext_address0 = zext_ln540_fu_321_p1;
    end else if ((1'b1 == ap_CS_fsm_state2)) begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state5)) begin
        pubkey_plaintext_address0 = zext_ln543_fu_346_p1;
    end else if ((1'b1 == ap_CS_fsm_state2)) begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state8) | ((1'b1 == ap_CS_fsm_state5) & (icmp_ln542_fu_334_p2 == 1'd1)))) begin
        sk_we0 = 1'b1;
    end else begin
        sk_we0 = 1'b0;
    end
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state5 : begin
            if (((1'b1 == ap_CS_fsm_state5) & (icmp_ln542_fu_334_p2 == 1'd1))) begin
...
assign DRBG_ctx_Key_address1 = grp_picnic_keygen_fu_250_DRBG_ctx_Key_address1;

assign DRBG_ctx_Key_ce0 = grp_picnic_keygen_fu_250_DRBG_ctx_Key_ce0;

assign DRBG_ctx_Key_ce1 = grp_picnic_keygen_fu_250_DRBG_ctx_Key_ce1;
...
assign DRBG_ctx_V_address1 = grp_picnic_keygen_fu_250_DRBG_ctx_V_address1;

assign DRBG_ctx_V_ce0 = grp_picnic_keygen_fu_250_DRBG_ctx_V_ce0;

assign DRBG_ctx_V_ce1 = grp_picnic_keygen_fu_250_DRBG_ctx_V_ce1;
...
assign add_ln543_1_fu_355_p2 = (zext_ln542_reg_444 + 6'd17);
...
assign icmp_ln539_fu_309_p2 = ((loop_0_i_reg_206 == 5'd16) ? 1'b1 : 1'b0);

assign icmp_ln542_fu_334_p2 = ((loop_1_i_reg_217 == 5'd16) ? 1'b1 : 1'b0);
...
assign zext_ln536_fu_304_p1 = grp_picnic_keygen_fu_250_ap_return_1;

assign zext_ln540_1_fu_326_p1 = loop_reg_433;

assign zext_ln540_fu_321_p1 = loop_0_i_reg_206;

assign zext_ln542_fu_330_p1 = loop_1_i_reg_217;

assign zext_ln543_1_fu_360_p1 = add_ln543_1_fu_355_p2;

assign zext_ln543_fu_346_p1 = loop_1_i_reg_217;

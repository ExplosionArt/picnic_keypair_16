...
architecture behav of Cipher is 
    ...
    signal icmp_ln310_fu_312_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal state_addr_13_reg_667 : STD_LOGIC_VECTOR (3 downto 0);
    signal state_addr_14_reg_672 : STD_LOGIC_VECTOR (3 downto 0);
    signal zext_ln426_fu_352_p1 : STD_LOGIC_VECTOR (5 downto 0);
    signal zext_ln426_reg_677 : STD_LOGIC_VECTOR (5 downto 0);
    ...
    signal xor_ln316_1_fu_537_p2 : STD_LOGIC_VECTOR (7 downto 0);
    signal xor_ln316_1_reg_697 : STD_LOGIC_VECTOR (7 downto 0);
    signal ap_CS_fsm_state18 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state18 : signal is "none";
    signal xor_ln317_fu_577_p2 : STD_LOGIC_VECTOR (7 downto 0);
    signal xor_ln317_reg_702 : STD_LOGIC_VECTOR (7 downto 0);
    ...
    signal icmp_ln421_fu_306_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal ap_CS_fsm_state4 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state4 : signal is "none";
    signal ap_CS_fsm_state21 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state21 : signal is "none";
    signal zext_ln312_fu_332_p1 : STD_LOGIC_VECTOR (63 downto 0);
    ...
    signal xor_ln314_1_fu_443_p2 : STD_LOGIC_VECTOR (7 downto 0);
    signal xor_ln315_1_fu_490_p2 : STD_LOGIC_VECTOR (7 downto 0);
    ...
    signal or_ln313_fu_337_p2 : STD_LOGIC_VECTOR (4 downto 0);
    signal or_ln313_1_fu_363_p2 : STD_LOGIC_VECTOR (4 downto 0);
    signal or_ln313_2_fu_377_p2 : STD_LOGIC_VECTOR (4 downto 0);
    signal Tm_fu_391_p2 : STD_LOGIC_VECTOR (7 downto 0);
    signal xor_ln313_1_fu_397_p2 : STD_LOGIC_VECTOR (7 downto 0);
    signal tmp_21_fu_415_p3 : STD_LOGIC_VECTOR (0 downto 0);
    signal select_ln302_fu_423_p3 : STD_LOGIC_VECTOR (7 downto 0);
    signal shl_ln302_fu_409_p2 : STD_LOGIC_VECTOR (7 downto 0);
    signal Tmp_fu_403_p2 : STD_LOGIC_VECTOR (7 downto 0);
    signal xor_ln314_2_fu_437_p2 : STD_LOGIC_VECTOR (7 downto 0);
    signal xor_ln314_fu_431_p2 : STD_LOGIC_VECTOR (7 downto 0);
    signal Tm_1_fu_450_p2 : STD_LOGIC_VECTOR (7 downto 0);
    signal tmp_22_fu_462_p3 : STD_LOGIC_VECTOR (0 downto 0);
    signal select_ln302_1_fu_470_p3 : STD_LOGIC_VECTOR (7 downto 0);
    signal shl_ln302_1_fu_456_p2 : STD_LOGIC_VECTOR (7 downto 0);
    signal xor_ln315_2_fu_484_p2 : STD_LOGIC_VECTOR (7 downto 0);
    signal xor_ln315_fu_478_p2 : STD_LOGIC_VECTOR (7 downto 0);
    signal Tm_2_fu_497_p2 : STD_LOGIC_VECTOR (7 downto 0);
    signal tmp_23_fu_509_p3 : STD_LOGIC_VECTOR (0 downto 0);
    signal select_ln302_2_fu_517_p3 : STD_LOGIC_VECTOR (7 downto 0);
    signal shl_ln302_2_fu_503_p2 : STD_LOGIC_VECTOR (7 downto 0);
    signal xor_ln316_2_fu_531_p2 : STD_LOGIC_VECTOR (7 downto 0);
    signal xor_ln316_fu_525_p2 : STD_LOGIC_VECTOR (7 downto 0);
    signal Tm_3_fu_543_p2 : STD_LOGIC_VECTOR (7 downto 0);
    signal tmp_24_fu_555_p3 : STD_LOGIC_VECTOR (0 downto 0);
    signal shl_ln302_3_fu_549_p2 : STD_LOGIC_VECTOR (7 downto 0);
    signal xor_ln317_2_fu_571_p2 : STD_LOGIC_VECTOR (7 downto 0);
    signal select_ln302_3_fu_563_p3 : STD_LOGIC_VECTOR (7 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if (((ap_const_logic_1 = ap_CS_fsm_state33) or ((ap_start = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state1)) or ((ap_const_logic_1 = ap_CS_fsm_state16) and (icmp_ln310_fu_312_p2 = ap_const_lv1_1)))) then 
    ...
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if ((((icmp_ln421_fu_306_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state3)) or ((ap_const_logic_1 = ap_CS_fsm_state3) and (icmp_ln421_fu_306_p2 = ap_const_lv1_0)))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_state16) and (icmp_ln310_fu_312_p2 = ap_const_lv1_1))) then
                round_reg_682 <= round_fu_357_p2;
                    zext_ln426_reg_677(3 downto 0) <= zext_ln426_fu_352_p1(3 downto 0);
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_state16) and (icmp_ln310_fu_312_p2 = ap_const_lv1_0))) then
                    state_addr_13_reg_667(3 downto 2) <= zext_ln312_fu_332_p1(4 - 1 downto 0)(3 downto 2);
    ...
    zext_ln426_reg_677(5 downto 4) <= "00";
    state_addr_15_reg_687(1 downto 0) <= "10";
    state_addr_16_reg_692(1 downto 0) <= "11";

    ap_NS_fsm_assign_proc : process (ap_start, ap_CS_fsm, ap_CS_fsm_state1, ap_CS_fsm_state2, grp_AddRoundKey_fu_245_ap_done, ap_CS_fsm_state16, icmp_ln310_fu_312_p2, grp_SubBytes_fu_256_ap_done, ap_CS_fsm_state20, ap_CS_fsm_state34, ap_CS_fsm_state3, icmp_ln421_fu_306_p2, ap_CS_fsm_state4, ap_CS_fsm_state21)
    begin
        case ap_CS_fsm is
            ...
            when ap_ST_fsm_state3 => 
                if (((icmp_ln421_fu_306_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state3))) then
    ...
    Tmp_fu_403_p2 <= (xor_ln313_1_fu_397_p2 xor state_q1);
    ...
    grp_AddRoundKey_fu_245_round_assign_proc : process(ap_CS_fsm_state2, zext_ln426_reg_677, ap_CS_fsm_state20, ap_CS_fsm_state34)
    begin
    ...
    icmp_ln310_fu_312_p2 <= "1" when (i_0_i_reg_234 = ap_const_lv3_4) else "0";
    icmp_ln421_fu_306_p2 <= "1" when (round_0_reg_222 = ap_const_lv4_E) else "0";
    or_ln313_1_fu_363_p2 <= (tmp_reg_661 or ap_const_lv5_2);
    or_ln313_2_fu_377_p2 <= (tmp_reg_661 or ap_const_lv5_3);
    or_ln313_fu_337_p2 <= (tmp_fu_324_p3 or ap_const_lv5_1);
    round_fu_357_p2 <= std_logic_vector(unsigned(round_0_reg_222) + unsigned(ap_const_lv4_1));
    select_ln302_1_fu_470_p3 <= 
        ap_const_lv8_1B when (tmp_22_fu_462_p3(0) = '1') else 
        ap_const_lv8_0;
    select_ln302_2_fu_517_p3 <= 
        ap_const_lv8_1B when (tmp_23_fu_509_p3(0) = '1') else 
        ap_const_lv8_0;
    select_ln302_3_fu_563_p3 <= 
        ap_const_lv8_1B when (tmp_24_fu_555_p3(0) = '1') else 
        ap_const_lv8_0;
    select_ln302_fu_423_p3 <= 
        ap_const_lv8_1B when (tmp_21_fu_415_p3(0) = '1') else 
        ap_const_lv8_0;
    shl_ln302_1_fu_456_p2 <= std_logic_vector(shift_left(unsigned(Tm_1_fu_450_p2),to_integer(unsigned('0' & ap_const_lv8_1(8-1 downto 0)))));
    shl_ln302_2_fu_503_p2 <= std_logic_vector(shift_left(unsigned(Tm_2_fu_497_p2),to_integer(unsigned('0' & ap_const_lv8_1(8-1 downto 0)))));
    shl_ln302_3_fu_549_p2 <= std_logic_vector(shift_left(unsigned(Tm_3_fu_543_p2),to_integer(unsigned('0' & ap_const_lv8_1(8-1 downto 0)))));
    shl_ln302_fu_409_p2 <= std_logic_vector(shift_left(unsigned(Tm_fu_391_p2),to_integer(unsigned('0' & ap_const_lv8_1(8-1 downto 0)))));

    state_address0_assign_proc : process(ap_CS_fsm_state6, ap_CS_fsm_state11, ap_CS_fsm_state17, ap_CS_fsm_state23, ap_CS_fsm_state28, ap_CS_fsm_state7, ap_CS_fsm_state24, ap_CS_fsm_state8, ap_CS_fsm_state25, ap_CS_fsm_state9, ap_CS_fsm_state26, ap_CS_fsm_state10, ap_CS_fsm_state27, ap_CS_fsm_state2, ap_CS_fsm_state16, icmp_ln310_fu_312_p2, state_addr_13_reg_667, state_addr_15_reg_687, ap_CS_fsm_state18, grp_AddRoundKey_fu_245_state_address0, grp_SubBytes_fu_256_state_address0, ap_CS_fsm_state20, ap_CS_fsm_state15, ap_CS_fsm_state19, ap_CS_fsm_state34, ap_CS_fsm_state4, ap_CS_fsm_state21, zext_ln312_fu_332_p1, tmp_1_fu_368_p3, ap_CS_fsm_state5, ap_CS_fsm_state12, ap_CS_fsm_state13, ap_CS_fsm_state14, ap_CS_fsm_state22, ap_CS_fsm_state29, ap_CS_fsm_state30, ap_CS_fsm_state31, ap_CS_fsm_state32)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state19)) then 
        ...
        elsif (((ap_const_logic_1 = ap_CS_fsm_state16) and (icmp_ln310_fu_312_p2 = ap_const_lv1_0))) then 
            state_address0 <= zext_ln312_fu_332_p1(4 - 1 downto 0);
    ...
    state_d0_assign_proc : process(reg_264, ap_CS_fsm_state11, ap_CS_fsm_state28, reg_276, reg_281, reg_291, ap_CS_fsm_state2, xor_ln316_1_reg_697, ap_CS_fsm_state18, grp_AddRoundKey_fu_245_state_d0, grp_SubBytes_fu_256_state_d0, ap_CS_fsm_state20, ap_CS_fsm_state15, ap_CS_fsm_state19, ap_CS_fsm_state34, ap_CS_fsm_state4, ap_CS_fsm_state21, ap_CS_fsm_state12, ap_CS_fsm_state13, ap_CS_fsm_state14, xor_ln314_1_fu_443_p2, ap_CS_fsm_state29, ap_CS_fsm_state30, ap_CS_fsm_state31, ap_CS_fsm_state32)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state19)) then 
    ...
    state_d1_assign_proc : process(state_q0, ap_CS_fsm_state6, ap_CS_fsm_state11, ap_CS_fsm_state23, ap_CS_fsm_state28, reg_270, reg_286, reg_296, reg_301, ap_CS_fsm_state10, ap_CS_fsm_state27, ap_CS_fsm_state18, xor_ln317_reg_702, ap_CS_fsm_state15, ap_CS_fsm_state19, ap_CS_fsm_state12, ap_CS_fsm_state13, ap_CS_fsm_state14, xor_ln315_1_fu_490_p2, ap_CS_fsm_state29, ap_CS_fsm_state30, ap_CS_fsm_state31, ap_CS_fsm_state32)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state19)) then 
    ...
    tmp_1_fu_368_p3 <= (ap_const_lv59_0 & or_ln313_1_fu_363_p2);
    ...
    tmp_2_fu_382_p3 <= (ap_const_lv59_0 & or_ln313_2_fu_377_p2);
    tmp_fu_324_p3 <= (i_0_i_reg_234 & ap_const_lv2_0);
    tmp_s_fu_343_p3 <= (ap_const_lv59_0 & or_ln313_fu_337_p2);
    xor_ln313_1_fu_397_p2 <= (state_q0 xor Tm_fu_391_p2);
    xor_ln314_1_fu_443_p2 <= (xor_ln314_fu_431_p2 xor xor_ln314_2_fu_437_p2);
    xor_ln314_2_fu_437_p2 <= (shl_ln302_fu_409_p2 xor Tmp_fu_403_p2);
    xor_ln314_fu_431_p2 <= (select_ln302_fu_423_p3 xor reg_264);
    xor_ln315_1_fu_490_p2 <= (xor_ln315_fu_478_p2 xor xor_ln315_2_fu_484_p2);
    xor_ln315_2_fu_484_p2 <= (shl_ln302_1_fu_456_p2 xor Tmp_fu_403_p2);
    xor_ln315_fu_478_p2 <= (select_ln302_1_fu_470_p3 xor reg_270);
    xor_ln316_1_fu_537_p2 <= (xor_ln316_fu_525_p2 xor xor_ln316_2_fu_531_p2);
    xor_ln316_2_fu_531_p2 <= (shl_ln302_2_fu_503_p2 xor Tmp_fu_403_p2);
    xor_ln316_fu_525_p2 <= (state_q0 xor select_ln302_2_fu_517_p3);
    xor_ln317_2_fu_571_p2 <= (xor_ln313_1_fu_397_p2 xor shl_ln302_3_fu_549_p2);
    xor_ln317_fu_577_p2 <= (xor_ln317_2_fu_571_p2 xor select_ln302_3_fu_563_p3);
    zext_ln312_fu_332_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_fu_324_p3),64));
    zext_ln426_fu_352_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(round_0_reg_222),6));
end behav;

...
signed int AESL_WRAP_crypto_sign_keypair( char *,  char *);
signed int fprint_aes256_struct();
signed int crypto_sign( char *, signed long long *,  char *, signed long long ,  char *);
signed int crypto_sign_open( char *, signed long long *,  char *, signed long long ,  char *);
...
llvm_cbe_tmp__86:
if (AESL_DEBUG_TRACE)
printf("\n  %%45 = call i32 @AESL_WRAP_crypto_sign_keypair(i8* %%14, i8* %%15) nounwind, !dbg !23 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_123_count);
  llvm_cbe_tmp__32 = (unsigned int )AESL_WRAP_crypto_sign_keypair(( char *)llvm_cbe_tmp__13, ( char *)llvm_cbe_tmp__14);
if (AESL_DEBUG_TRACE) {
...
printf("\n = 0x%I64X\n", llvm_cbe_tmp__65);
if (AESL_DEBUG_TRACE)
printf("\n  %%108 = call i32 @crypto_sign_open(i8* %%20, i64* %%mlen1, i8* %%19, i64 %%107, i8* %%16) nounwind, !dbg !23 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_240_count);
  llvm_cbe_tmp__66 = (unsigned int )crypto_sign_open(( char *)llvm_cbe_tmp__19, (signed long long *)(&llvm_cbe_mlen1), ( char *)llvm_cbe_tmp__18, llvm_cbe_tmp__65, ( char *)llvm_cbe_tmp__15);
if (AESL_DEBUG_TRACE) {

...
// ==============================================================
# 1 "C:/project16-master/NIST-KATs/rng.c"
# 1 "C:/project16-master/NIST-KATs/rng.c" 1
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 147 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "C:/project16-master/NIST-KATs/rng.c" 2
...
# 9 "C:/project16-master/NIST-KATs/rng.c" 2
...
# 10 "C:/project16-master/NIST-KATs/rng.c" 2
# 1 "C:/project16-master/NIST-KATs/aes.h" 1
...
# 5 "C:/project16-master/NIST-KATs/aes.h" 2
# 43 "C:/project16-master/NIST-KATs/aes.h"
struct AES_ctx
{
...
# 74 "C:/project16-master/NIST-KATs/aes.h"
void AES_CBC_encrypt_buffer(struct AES_ctx* ctx, uint8_t* buf, uint32_t length);
void AES_CBC_decrypt_buffer(struct AES_ctx* ctx, uint8_t* buf, uint32_t length);
# 87 "C:/project16-master/NIST-KATs/aes.h"
void AES_CTR_xcrypt_buffer(struct AES_ctx* ctx, uint8_t* buf, uint32_t length);
# 11 "C:/project16-master/NIST-KATs/rng.c" 2
...
# 54 "C:/project16-master/NIST-KATs/rng.c"
int
seedexpander_init(AES_XOF_struct *ctx,
                  unsigned char *seed,
                  unsigned char *diversifier,
...
# 248 "C:/project16-master/NIST-KATs/rng.c"
  int loop;
  for (loop=0;loop<16;loop++)
#pragma HLS UNROLL skip_exit_check
 x[loop] = block[loop];
  xlen -= 16;
# 262 "C:/project16-master/NIST-KATs/rng.c"
...
randombytes_sign(unsigned char *x, unsigned long long xlen)
{
    ...
    int i = 0;
        ...
        AES256_ECB(DRBG_ctx.Key, DRBG_ctx.V, block);
# 295 "C:/project16-master/NIST-KATs/rng.c"
         int loop;
         for (loop=0;loop<16;loop++)
          x[i+loop] = block[loop];
            i += 16;
            xlen -= 16;
# 309 "C:/project16-master/NIST-KATs/rng.c"
    AES256_CTR_DRBG_Update(((void*)0), DRBG_ctx.Key, DRBG_ctx.V);
    DRBG_ctx.reseed_counter++;

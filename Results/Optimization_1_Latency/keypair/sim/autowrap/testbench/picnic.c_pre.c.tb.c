...
// ==============================================================
# 1 "C:/project16-master/picnic.c"
# 1 "C:/project16-master/picnic.c" 1
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 147 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "C:/project16-master/picnic.c" 2
# 12 "C:/project16-master/picnic.c"
...
# 13 "C:/project16-master/picnic.c" 2
...
# 1 "D:/Xilinx_Vivado/Vivado/2019.2/win64/tools/clang/bin/../lib/clang/3.1/../../../x86_64-w64-mingw32/include\\_mingw.h" 1 3
# 9 "D:/Xilinx_Vivado/Vivado/2019.2/win64/tools/clang/bin/../lib/clang/3.1/../../../x86_64-w64-mingw32/include\\memory.h" 2 3
# 23 "D:/Xilinx_Vivado/Vivado/2019.2/win64/tools/clang/bin/../lib/clang/3.1/../../../x86_64-w64-mingw32/include\\memory.h" 3
...
# 14 "C:/project16-master/picnic.c" 2
...
# 15 "C:/project16-master/picnic.c" 2
...
# 16 "C:/project16-master/picnic.c" 2
...
# 17 "C:/project16-master/picnic.c" 2
...
# 18 "C:/project16-master/picnic.c" 2
...
# 19 "C:/project16-master/picnic.c" 2
...
# 20 "C:/project16-master/picnic.c" 2
# 1 "C:/project16-master/platform.h" 1
# 21 "C:/project16-master/picnic.c" 2
...
# 150 "C:/project16-master/picnic.c"
...
# 188 "C:/project16-master/picnic.c"
    paramset_t paramset;
...
#pragma HLS UNROLL
 temp[loop/4] = pk->ciphertext[loop] + 256*(pk->ciphertext[loop+1] + 256*(pk->ciphertext[loop+2] + 256*pk->ciphertext[loop+3]));
    ...
    LowMCEnc(temp2, temp, temp3, &paramset);
                ...
                uint8_t* signature, size_t* signature_len)
{
    ...
    if (ret != 0) {
        ...
        *signature_len = ret;
# 338 "C:/project16-master/picnic.c"
    return 0;
}
                  ...
                  const uint8_t* signature, size_t signature_len)
{
    ...
    if (ret != 0) {
        ...
        signature_t sig[1];
# 463 "C:/project16-master/picnic.c"
...
# 521 "C:/project16-master/picnic.c"
    return 0;
}

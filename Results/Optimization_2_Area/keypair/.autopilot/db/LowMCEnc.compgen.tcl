...
set ID 40
set hasByteEnable 0
set MemName LowMCEnc_temp_matg8j
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename output_r \
    op interface \
    ports { output_r_address0 { O 3 vector } output_r_ce0 { O 1 bit } output_r_we0 { O 1 bit } output_r_d0 { O 32 vector } output_r_q0 { I 32 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename key \
    op interface \
    ports { key_address0 { O 3 vector } key_ce0 { O 1 bit } key_q0 { I 32 vector } } \
} "
} else {

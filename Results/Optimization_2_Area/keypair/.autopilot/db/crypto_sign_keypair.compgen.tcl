...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename DRBG_ctx_V \
    op interface \
    ports { DRBG_ctx_V_address0 { O 4 vector } DRBG_ctx_V_ce0 { O 1 bit } DRBG_ctx_V_we0 { O 1 bit } DRBG_ctx_V_d0 { O 8 vector } DRBG_ctx_V_q0 { I 8 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    op interface \
    ports { DRBG_ctx_Key_address0 { O 5 vector } DRBG_ctx_Key_ce0 { O 1 bit } DRBG_ctx_Key_we0 { O 1 bit } DRBG_ctx_Key_d0 { O 8 vector } DRBG_ctx_Key_q0 { I 8 vector } } \
} "
} else {
